...
may = [h for h in history_list if str(h.get('date') or h.get('timestamp') or '').startswith('2026-05')]
...
apr = [h for h in history_list if str(h.get('date') or h.get('timestamp') or '').startswith('2026-04')]
