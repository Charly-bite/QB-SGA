...
class TemplateManager:
    ...
    AVAILABLE_FIELDS = {
        'process_barcode': {'label': 'Código de Proceso', 'type': 'barcode', 'default_value': '01-ENVASADO'},
        'internal_code_barcode': {'label': 'Código Interno (Barcode)', 'type': 'barcode'},
        ...
        'h_header': {'label': 'Encabezado Indicaciones', 'type': 'static', 'default_value': 'INDICACIONES DE PELIGRO:'},
        'p_header': {'label': 'Encabezado Consejos', 'type': 'static', 'default_value': 'CONSEJOS DE PRUDENCIA:'},
        'elab_date_label': {'label': 'Etiqueta F.Elaboración', 'type': 'static', 'default_value': 'F.ELABORACION:'},
        'elab_date_value': {'label': 'Valor F.Elaboración', 'type': 'text'},
        'reinsp_date_label': {'label': 'Etiqueta F.Reinspección', 'type': 'static', 'default_value': 'F.REINSPECCION:'},
        'reinsp_date_value': {'label': 'Valor F.Reinspección', 'type': 'text'},
        'lote_label': {'label': 'Etiqueta LOTE', 'type': 'static', 'default_value': 'LOTE:'},
        'lote_value': {'label': 'Valor LOTE', 'type': 'text'},
        'batch_barcode': {'label': 'Código de Barras LOTE', 'type': 'barcode'},
        'peso_bruto_label': {'label': 'Etiqueta Peso Bruto', 'type': 'static', 'default_value': 'PESO BRUTO:'},
        'peso_bruto_value': {'label': 'Valor Peso Bruto', 'type': 'text'},
        'peso_tara_label': {'label': 'Etiqueta Peso Tara', 'type': 'static', 'default_value': 'PESO TARA:'},
        'peso_tara_value': {'label': 'Valor Peso Tara', 'type': 'text'},
        'peso_neto_label': {'label': 'Etiqueta Peso Neto', 'type': 'static', 'default_value': 'PESO NETO:'},
        'peso_neto_value': {'label': 'Valor Peso Neto', 'type': 'text'},
        'net_weight_barcode': {'label': 'Código de Barras Peso Neto', 'type': 'barcode'},
        'gross_weight_barcode': {'label': 'Código de Barras Peso Bruto', 'type': 'barcode'},
        'address_footer': {'label': 'Dirección Pie de Página', 'type': 'static',
        ...
        'static_text': {'label': 'Texto Libre', 'type': 'static', 'default_value': 'Texto'},
        'ghs_pictograms': {'label': 'Pictogramas del Producto', 'type': 'pictogram_group'},
        'company_logo': {'label': 'Logo Empresa', 'type': 'image'},
        'ghs_pictograms_locked': {'label': 'Pictogramas Bloqueados', 'type': 'pictogram_group_locked'},
    }
